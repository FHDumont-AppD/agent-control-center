import FuseScrollbars from "src/@internal/core/FuseScrollbars";
import { styled, ThemeProvider, useTheme } from "@mui/material/styles";
import ClickAwayListener from "@mui/material/ClickAwayListener";
import clsx from "clsx";
import { memo, useEffect, useState } from "react";
import { useDispatch, useSelector } from "react-redux";
import FuseNavigation from "src/@internal/core/FuseNavigation";
import { navbarCloseMobile } from "app/store/fuse/navbarSlice";
import { selectContrastMainTheme } from "app/store/fuse/settingsSlice";
import { useLocation } from "react-router-dom";
import useThemeMediaQuery from "src/@internal/hooks/useThemeMediaQuery";
        ...
        <ThemeProvider theme={contrastTheme}>
          ...
          >
            <img
              ...
              src="assets/images/logo/appd-logo-v1.svg"
              alt="logo"
            />
